...
async def _(event):
    ...
    try:
        ...
        return
    with open("tts @DolaRobot.mp3", "r"):
        await tbot.send_file(
            event.chat_id, "tts @DolaRobot.mp3", voice_note=True, reply_to=reply_to_id
        )
        os.remove("tts @DolaRobot.mp3")
